...
testSupport([
  ...
  { client: 'Chromium' },
  { client: 'Electron' },
  { client: 'Chromium', os: 'Android' },
  { client: 'Chrome', os: 'Android' },
  { client: 'Firefox', os: 'Android' },
  { client: 'Samsung Internet', os: 'Android' },
  { client: 'Edge', os: 'Android' },
  { client: 'Opera', os: 'Android' },
  { client: 'Chromium', os: 'iOS' },
  { client: 'Chrome', os: 'iOS' },
  { client: 'Firefox', os: 'iOS' },
